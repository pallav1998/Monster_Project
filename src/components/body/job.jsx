        ...
        <Fragment>
            <a href="#a" style={{padding:"0px",height:"150px",width:"255px"}}>
                <div style={{display:"flex",flexDirection:"row"}}>
                    ...
                    <a href="#a" style={{marginLeft:"80px",textDecoration:"none"}}>Read More</a>
                    </div>
                </div>
            </a>
        </Fragment>
        ...
        <Fragment>
           <div>
                <div className={styles.jobs_div}>
                    ...
                    <a href="#a">view all {">"}</a>
                    <div>
                        <div style={{display:sidebtn?"block":"none"}}><CgChevronLeft /></div>
                        ...
                        <div style={{display:sidebtn?"block":"none"}}><CgChevronRight /></div>
                    </div>
                </div>
            </div>
        </Fragment>
