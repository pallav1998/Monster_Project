            ...
            <div className={styles.main_info}>
                <div className ={styles.info_cont}>
                    <div>
                        ...
                        <div><h3>What it feels like to have 48% more interview calls?</h3>
                    ...
                    <div className={styles.contact_mobile}>
                        <div><p>Find Better {'&'} Faster with Monster Career Services
                            <br/>Call 1-800-4196666 now! (Toll-free)</p></div>
                        <div><input type="text" placeholder="Enter your mobile number" />
                    ...
                    <div>
                        <div className={styles.jobs_div}>
                            ...
                            <div className={styles.report} style={{flexDirection:"column"}}>
                                <h3>Monster Employment Index</h3>
                                <p>The Monster Employment Index is a broad and
                                    comprehensive monthly analysis of online job posting activity conducted by Monster India.</p>
                    ...
                    <div>
                        <div className={styles.advice}>
                            ...
                            <div>
                                <div>
                                    <p>Resume Format for Freshers: Writing guide, Tips, Samples</p>
                                    <p>Student Resume Examples: Samples, Guide , Writing Tips to get Internship Quickly</p>
                                    <p>Objective for Resume for Fresher and Experienced</p>
                                </div>
                                <div>
                                    <p>Professional Resume Summary: Examples , Writing Tips</p>
                                    <p>Career Options After 12th PCB , High Salary Courses After 12th PCB</p>
